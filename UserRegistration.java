...
public class UserRegistration extends JFrame {
    ...
    public UserRegistration() {
        ...
        JLabel lblNewUserRegister = new JLabel("Admin Registeration");
        lblNewUserRegister.setFont(new Font("Serif", Font.BOLD+Font.ITALIC, 35));
       ...
       lblName.setFont(new Font("Serif", Font.BOLD+Font.ITALIC, 20));
        ...
        firstname.setFont(new Font("Serif", Font.BOLD+Font.ITALIC,32));
        firstname.setBounds(214, 151, 228, 50);
        contentPane.add(firstname);
        firstname.setColumns(10);

        lastname = new JTextField();
        lastname.setFont(new Font("Serif", Font.BOLD+Font.ITALIC, 32));
        ...
        email.setFont(new Font("Serif", Font.BOLD+Font.ITALIC, 32));
        email.setBounds(214, 320, 228, 50);
        contentPane.add(email);
        email.setColumns(10);

        username = new JTextField();
        username.setFont(new Font("Serif", Font.BOLD+Font.ITALIC, 32));
        ...
        lblMobileNumber.setFont(new Font("Serif", Font.BOLD+Font.ITALIC, 20));
        lblMobileNumber.setBounds(542, 329, 139, 26);
        contentPane.add(lblMobileNumber);

        mob = new JTextField();
        mob.setFont(new Font("Serif", Font.BOLD+Font.ITALIC,32));
        mob.setBounds(707, 320, 228, 50);
        contentPane.add(mob);
        mob.setColumns(10);

        passwordField = new JPasswordField();
        passwordField.setFont(new Font("Serif", Font.BOLD+Font.ITALIC, 32));
